...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl uppercase tracking-wide text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-slate-500 text-primary-foreground hover:bg-green-500/90 border-slate-600 border-b-4 active:border-b-0",
